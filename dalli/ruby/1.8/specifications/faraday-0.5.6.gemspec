...
Gem::Specification.new do |s|
  ...
  s.files = ["Gemfile", "LICENSE", "README.md", "Rakefile", "faraday.gemspec", "lib/faraday.rb", "lib/faraday/adapter.rb", "lib/faraday/adapter/action_dispatch.rb", "lib/faraday/adapter/em_synchrony.rb", "lib/faraday/adapter/excon.rb", "lib/faraday/adapter/net_http.rb", "lib/faraday/adapter/patron.rb", "lib/faraday/adapter/test.rb", "lib/faraday/adapter/typhoeus.rb", "lib/faraday/builder.rb", "lib/faraday/connection.rb", "lib/faraday/error.rb", "lib/faraday/middleware.rb", "lib/faraday/request.rb", "lib/faraday/request/active_support_json.rb", "lib/faraday/request/yajl.rb", "lib/faraday/response.rb", "lib/faraday/response/active_support_json.rb", "lib/faraday/response/yajl.rb", "lib/faraday/upload_io.rb", "lib/faraday/utils.rb", "test/adapters/live_test.rb", "test/adapters/test_middleware_test.rb", "test/adapters/typhoeus_test.rb", "test/connection_app_test.rb", "test/connection_test.rb", "test/env_test.rb", "test/form_post_test.rb", "test/helper.rb", "test/live_server.rb", "test/multipart_test.rb", "test/request_middleware_test.rb", "test/response_middleware_test.rb"]
